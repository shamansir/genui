module GenUI.Json.Decode exposing (decode, decode_)
...
{-| JSON Decoder for the cases when value was included in data at the `_value_` field (see `Json.Encode.encode_`) -}
