    ...
    , b.nest
        ...
        (b.children
            [ b.select "function" animations "Random spline animation"
                // b.bind_to "animFunc"
            , b.text "fps" "60" // b.bind_to "videoFps"
            , b.text "length" "30" // b.bind_to "videoLength"
            , b.text "mask" "" // b.bind_to "maskFilename"
            , b.toggle "invertMask" False // b.bind_to "videoInvertMask"
            ...
            , b.action "request" // b.bind_to "requestVideo"
            ]
        )
        False
    ] : P.GenUI